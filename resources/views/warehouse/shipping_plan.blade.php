...
@section('main')
  ...
  <div class="container">
    ...
    @endif
    <h1>出庫予定情報入力</h1>
    <form id="ship_header_form" method="post" action='{{ action('LogisticController@create_ship_plan') }}'>
      {{ csrf_field() }}
    </form>
        <div class="main_header">
          ...
          <h2>出庫情報</h2>
              出庫番号&nbsp;
                  <input form="ship_header_form" type="number" name="shipping_no" value="{{ $new_shipplan_id }}" readonly><br>
              倉庫&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <select form="ship_header_form" name="warehouse" size="1">
              ...
              <br>
              出庫日&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input form="ship_header_form" type="date" name="shipping_date" value="{{ $now->format('Y-m-d') }}"><br>
              納品先&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <select form="ship_header_form" name="supplier" size="1">
        ...
        <div class="main_footer">
          <hr>
          <h2>商品情報</h2>
          <form id="item_add_form" method="post" action='{{ action('LogisticController@create_ship_plan') }}'>
              {{ csrf_field() }}
            </form>
            商品番号&nbsp;
            ...
            <input class="add_item_name" form="item_add_form" type="text" name="" value="" placeholder="商品名称" disabled>
                <button id="item_search_btn">検索</button><br>
            数量&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <input form="ship_header_form" type="submit" value="送信">
  ...
  // 商品追加
    $('#item_add_form').submit(function(event) {
      ...
      $('#show_items tr:first').addClass('row');
        ...
        $('#show_items tr:first').append('<input>');
        $('#show_items tr:first input:first').attr('form','ship_header_form')
                                    .attr('type','hidden')
                                    .attr('name','item_list[]')
                                    .attr('value', item);
        $('#show_items tr:first input:last').attr('form','ship_header_form')
                                    .attr('type','hidden')
